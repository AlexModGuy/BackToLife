...
public class ModelTarbosaurus extends ModelPrehistoric {
	...
	public ModelTarbosaurus() {
		...
		this.UpperJaw1.setRotationPoint(0.0F, -3.0F, -8.0F);
		this.UpperJaw1.addBox(-2.5F, 0.0F, -5.0F, 5, 5, 5, 0.0F);
		...
		this.UpperJaw3.addBox(-1.5F, -0.8F, 0.0F, 3, 1, 8, 0.0F);
		...
		this.UpperJaw2.setRotationPoint(0.0F, 5.0F, -5.0F);
		...
		this.Neck1.setRotationPoint(0.0F, 1.1F, -15.5F);
		this.Neck1.addBox(-2.5F, -5.0F, -10.0F, 5, 9, 13, 0.0F);
		...
		this.UpperJaw4 = new AdvancedModelRenderer(this, 79, 75);
		this.UpperJaw4.setRotationPoint(0.0F, -0.5F, 0.5F);
		this.UpperJaw4.addBox(-1.0F, -0.8F, 0.0F, 2, 1, 6, 0.0F);
		this.setRotateAngle(UpperJaw4, -0.03490658503988659F, 0.0F, 0.0F);
		...
		this.Head1.addBox(-3.0F, -4.0F, -8.0F, 6, 6, 10, 0.0F);
		this.headPivot = new AdvancedModelRenderer(this, 0, 75);
		this.headPivot.setRotationPoint(0.0F, -0.9F, -9.1F);
		...
		this.setRotateAngle(HeadFeathers2, 0.045553093477052F, -0.045553093477052F, -0.136659280431156F);
		...
		this.LowerTeeth2 = new AdvancedModelRenderer(this, 38, 47);
		this.LowerTeeth2.setRotationPoint(0.0F, -2.0F, 0.0F);
		this.LowerTeeth2.addBox(-1.0F, -1.0F, -3.5F, 2, 1, 4, 0.0F);
		this.LowerJaw2 = new AdvancedModelRenderer(this, 40, 85);
		this.LowerJaw2.setRotationPoint(0.0F, 0.0F, -5.0F);
		this.LowerJaw2.addBox(-2.5F, 0.0F, -4.0F, 5, 2, 4, 0.0F);
		...
		this.Gums.addBox(-2.5F, -6.0F, 0.0F, 5, 6, 5, 0.0F);
		this.setRotateAngle(Gums, -0.644201026911107F, 0.0F, 0.0F);
		...
		this.Tail3.addBox(-1.5F, -1.0F, 0.0F, 3, 4, 20, 0.0F);
		...
		this.Head2.addBox(-3.0F, 0.0F, -4.0F, 6, 3, 6, 0.0F);
		...
		this.LowerJaw1.setRotationPoint(0.0F, 0.0F, -3.0F);
		this.LowerJaw1.addBox(-3.0F, 0.0F, -5.0F, 6, 3, 4, 0.0F);
		this.LowerJaw4 = new AdvancedModelRenderer(this, 45, 94);
		this.LowerJaw4.setRotationPoint(0.0F, 3.0F, -5.0F);
		this.LowerJaw4.addBox(-2.0F, -1.0F, -4.0F, 4, 1, 4, 0.0F);
		this.setRotateAngle(LowerJaw4, -0.10471975511965977F, 0.0F, 0.0F);
		...
		this.UpperTeeth2 = new AdvancedModelRenderer(this, 38, 38);
		this.UpperTeeth2.setRotationPoint(0.0F, 0.0F, -3.5F);
		this.UpperTeeth2.addBox(-1.5F, 0.0F, 0.0F, 3, 1, 4, 0.0F);
		...
		this.setRotateAngle(HeadFeathers1, 0.18203784098300857F, 0.0F, 0.0F);
		...
		this.setRotateAngle(HeadFeathers3, 0.045553093477052F, 0.045553093477052F, 0.136659280431156F);
		...
		this.LowerJaw3.addBox(-2.0F, -2.0F, -4.0F, 4, 2, 4, 0.0F);
		this.setRotateAngle(LowerJaw3, -0.136659280431156F, 0.0F, 0.0F);
		this.LowerTeeth1 = new AdvancedModelRenderer(this, 23, 47);
		this.LowerTeeth1.setRotationPoint(0.0F, 0.0F, 0.5F);
		this.LowerTeeth1.addBox(-1.5F, -1.0F, -4.0F, 3, 1, 4, 0.0F);
		this.UpperTeeth1 = new AdvancedModelRenderer(this, 20, 38);
		this.UpperTeeth1.setRotationPoint(0.0F, 5.0F, -4.5F);
		this.UpperTeeth1.addBox(-2.0F, 0.0F, 0.0F, 4, 1, 4, 0.0F);
